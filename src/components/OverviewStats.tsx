  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <Card className="text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-border shadow-md group">
        ...
        <CardContent>
          <div className="text-3xl font-display font-bold text-primary mb-1">{totalCompleted}/{totalHabits}</div>
      ...
      <Card className="text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-border shadow-md group">
        ...
        <CardContent>
          ...
          {weeklyGoalMet && (
            <Badge variant="default" className="mt-2">Goal Achieved!</Badge>
          )}
        </CardContent>
      </Card>
      ...
      <Card className="text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-border shadow-md group">
        ...
        <CardContent>
          <div className="text-3xl font-display font-bold text-secondary mb-1">{completionRate}%</div>
          <p className="text-sm font-semibold text-muted-foreground">TODAY'S RATE</p>
        </CardContent>
      </Card>
    </div>
  );
