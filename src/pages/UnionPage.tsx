...
import { ArrowLeft, Book, Plus, Trash2, ExternalLink, Heart, BookOpen } from "lucide-react";
...
const UnionPage = () => {
  ...
  const [resources, setResources] = useState([
    { id: '1', title: 'Daily Reading Plan', url: 'https://example.com', description: 'One year Bible reading plan' },
    { id: '2', title: 'Study Guide', url: 'https://example.com', description: 'Interactive Bible study guide' }
  ]);
  
  const [newResource, setNewResource] = useState({ title: '', url: '', description: '' });
  
  const [trackingHistory] = useState([
    { date: '2024-01-26', completed: true, notes: 'Read Psalm 23, reflected on God\'s care' },
    { date: '2024-01-25', completed: true, notes: 'Morning devotional time' },
    { date: '2024-01-24', completed: false, notes: '' },
    { date: '2024-01-23', completed: true, notes: 'Study on love and compassion' },
    { date: '2024-01-22', completed: true, notes: 'Quiet time with God' }
  ]);
  ...
  const addResource = () => {
    ...
    toast({
      ...
      description: "Union resource has been added successfully."
    });
  };
  ...
  const removeResource = (id: string) => {
    ...
    toast({
      ...
      description: "Union resource has been removed."
    });
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              ...
              by His heart for the world. This habit transforms us from the inside out.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <div className="text-center p-4 rounded-lg bg-muted/50">
                <BookOpen className="h-8 w-8 mx-auto mb-2 text-primary" />
                <h3 className="font-semibold">Daily Reading</h3>
                <p className="text-sm text-muted-foreground">Scripture and reflection</p>
              </div>
              <div className="text-center p-4 rounded-lg bg-muted/50">
                <Heart className="h-8 w-8 mx-auto mb-2 text-primary" />
                <h3 className="font-semibold">Heart Formation</h3>
                <p className="text-sm text-muted-foreground">Shaped by God's love</p>
              </div>
              <div className="text-center p-4 rounded-lg bg-muted/50">
                <Plus className="h-8 w-8 mx-auto mb-2 text-primary" />
                <h3 className="font-semibold">Resources</h3>
                <p className="text-sm text-muted-foreground">Study guides and plans</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle>Union Resources</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Union History</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
